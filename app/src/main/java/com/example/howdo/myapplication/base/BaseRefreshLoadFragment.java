...
/**
 * Created by howdo on 2016/11/8.
 */

public abstract class BaseRefreshLoadFragment extends Fragment {
    protected String TAG;
    protected App mApp;
    protected View mContentView;
    protected Engine mEngine;
    protected BaseRefreshLoadActivity mActivity;
    ...
    public void onAttach(Context context) {
        ...
        mActivity = (BaseRefreshLoadActivity) getActivity();
