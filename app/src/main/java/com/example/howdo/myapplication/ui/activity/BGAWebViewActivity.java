...
public class BGAWebViewActivity extends BaseActivityForTest implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.retweet) {
            ToastUtil.showText("点击了转发");
        } else if (v.getId() == R.id.comment) {
            ToastUtil.showText("点击了评论");
        } else if (v.getId() == R.id.praise) {
            ToastUtil.showText("点击了赞");
        }
    }
