...
import com.example.howdo.myapplication.constant.AppConstants;
import com.example.howdo.myapplication.ui.fragment.DesignLibraryFragment;
import com.example.howdo.myapplication.ui.fragment.SecondFragment;
import com.example.howdo.myapplication.ui.fragment.ThirdFragment;
...
/**
 * Created by howdo on 2016/12/19.
 */

public class DesignSupportLibraryActivity extends BaseActivity{
    ...
    protected int getLayoutId() {
        return R.layout.activity_main_coordination;
    }
    ...
    private void initFragment(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            currentFragment = new DesignLibraryFragment();
...
//                    AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_wuxiaolong, menu);
        return true;
    }
