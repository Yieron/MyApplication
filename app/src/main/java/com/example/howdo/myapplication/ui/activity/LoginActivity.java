...
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        checkBox = (CheckBox) findViewById(R.id.first_code_ck);

        preferences = PreferenceManager.getDefaultSharedPreferences(this);

        boolean rember_password = preferences.getBoolean("rember_password", false);
        if (rember_password) {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            if (email.equals("admin@163.com") && password.equals("123456")) {
                ...
                ToastUtil.showText("accouunt or  password is invalid");
            }
