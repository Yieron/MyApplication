...
import com.example.howdo.myapplication.ui.activity.DetailActivity;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (position % 2 == 0) {
            holder.showImage.setBackgroundResource(R.mipmap.icon);
        } else {
            holder.showImage.setBackgroundResource(R.mipmap.icon2);
        }
    }
