 ...
 * 描述:
 */
public class BGARefreshSwipeListViewFragment extends BaseFragmentForTest implements BGARefreshLayout.BGARefreshLayoutDelegate, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, BGAOnItemChildClickListener, BGAOnItemChildLongClickListener {
    private static final String TAG = BGARefreshSwipeListViewFragment.class.getSimpleName();
